...
import orangecycle2 from "../Image/orangecycle2.png";
import orangecycle from "../Image/orangecycle.png";
import { useInView } from "react-intersection-observer";
import clsx from "clsx";


export const Cycleorangeinfo = () => {
  ...
  return (
    <>
        ...
        <div className=" w-full py-[2rem]  lg:grid-cols-2 lg:grid-rows-2 lg:hidden">
          ...
          <div className=" overflow-x-hidden w-full col-start-1 row-start-1 row-span-2 lg:grid lg:grid-cols-2 lg:grid-row-2 ">
            <div className="min-w-max overflow-hidden object-center ">
              <img
                className={clsx(" w-[110vw]  overflow-hidden  relative -left-4 lg:hidden",inView1?"scale-110 transition-transform duration-[3s]":"")}
                src={orangecycle}
              />
      ...
      {/* large screen view */}
      <div  ref={ref} className="hidden lg:flex h-[90vh]  justify-end overflow-x-hidden overflow-y-hidden">
        <div className="grid grid-cols-2 pt-[13rem] px-[2rem]">
          <img className={clsx("px-[2rem]", inView?" scale-110 duration-1000  transition-transform":"") } src={orangecycle2} />
...
export default Cycleorangeinfo;
