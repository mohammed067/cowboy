...
import lavender2 from "../Image/lavender2.png";
...
function CycleLinfo() {
  ...
  return (
    <>
      <div ref={myRef}  style={{ background: "linear-gradient(247.2deg, #e3e5fc 8.64%, #f7f8fc 52.48%, #efeeeb 86.51%)" }}>
      ...
      {/* large screen view */}
      <div  ref={ref} className="hidden lg:flex h-[90vh]  overflow-x-hidden justify-end overflow-y-hidden " style={{ background: "linear-gradient(247.2deg, #e3e5fc 8.64%, #f7f8fc 52.48%, #efeeeb 86.51%)" }}>
        <div className="grid grid-cols-2 pt-[13rem] px-[2rem]">
          ...
          <img className={clsx("px-[2rem]", inView?" scale-110 duration-1000  transition-transform":"") } src={lavender2} />
        </div>
